...
declare class Cropper extends React.Component<CropperProps, State> {
  ...
  getPointOnContainer: ({
    x,
    y
  }: Point, containerTopLeft: Point) => Point;
  getPointOnMedia: ({
    x,
    y
  }: Point) => {
 ...
 */
declare function getInitialCropFromCroppedAreaPercentages(croppedAreaPercentages: Area, mediaSize: MediaSize, rotation: number, cropSize: Size, minZoom: number, maxZoom: number): {
  crop: {
    x: number;
    y: number;
  };
 ...
 */
declare function getInitialCropFromCroppedAreaPixels(croppedAreaPixels: Area, mediaSize: MediaSize, rotation: number | undefined, cropSize: Size, minZoom: number, maxZoom: number): {
  crop: Point;
  zoom: number;
};
//#endregion
export { Area, type CropperProps, MediaSize, Point, Size, VideoSrc, Cropper as default, getInitialCropFromCroppedAreaPercentages, getInitialCropFromCroppedAreaPixels };
